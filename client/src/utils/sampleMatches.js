export function getSampleMatches(seriesFilter) {
  ...
  const matches = [
    ...
    { team1: { id: 8, name: "Sri Lanka", short_name: "SL" }, team2: { id: 20, name: "Nepal", short_name: "NEP" }, match_time: "15:30", match_type: "league", dayOffset: 2, venue: "Arun Jaitley Stadium, Delhi", series: "worldcup" },
